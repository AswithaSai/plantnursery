...
<body>
    ...
    <div class="info">
        ...
        <?php
            ...
            $sql1 = "select Customer_name,Password from customer where User_Id ='$name' and Password ='$name1'  ";

            $res1=mysqli_query($conn, $sql1);
            $result1=mysqli_fetch_assoc($res1);
            if($result1){
                echo '<h1>Welcome '.$result1['Customer_name'].'</h1>';
                echo '<h1 align="Center" style="font-family:Gill Sans"> Your Orders : </h1><br>';
                $sql="select Order_Id,Plant_Id, Quantity,Amount , User_Id , Delivery from orders where User_Id = '$name' ";
                ...
                <th width="250px">Delivery Status</th></tr>';
        ...
        echo '<br><br>
        <div class="div1">
        <span class="block"><a href="adminBuy.php"><span 
