...
<head>
    ...
    <style>
        ...
        .head{
            background-color:rgb(236,77,124);color:ghostwhite;padding-top:1%;padding-bottom:1%;
            margin-top:1%;
...
<table>
    ...
    <nav class="navbar sticky-top navbar-light bg-dark link-text-white text-white" >
        ...
        <a class="navbar-brand" href="Customers.php"><span style="color:ghostwhite">Customer Details</span></a>
    ...
    <?php
        ...
        echo '<h3 align="center" class="head">Welcome '.$name.'<br>A very nice day to you</h3>';
   ?>
...
<body>
    ...
    <nav class="navbar sticky-top navbar-light bg-dark link-text-white text-white" >
        ...
        <a class="navbar-brand" href="aboutUs.html"><span style="color:ghostwhite">About Us</span> </a>
        <a class="navbar-brand" href="chat.php"><span style="color:ghostwhite">Chat with bot</span></a>
...
<!-- <nav class="navbar sticky navbar-light bg-dark text-success">
    ...
    <nav class="navbar sticky-top navbar-light bg-dark link-text-white text-white" >
        ...
        <a class="navbar-brand" href="contactUs.html"><span style="color:ghostwhite">Contact Us</span></a>
        <a class="navbar-brand" href="Customer.html"><span style="color:ghostwhite">Customers</span></a>
        <a class="navbar-brand" href="ViewOrders.php"><span style="color:ghostwhite">View Orders</span></a>
